 ...
 *
 * 1. 配置类， @Configuration
 * 2. @MapperScan(basePackages = { "org.hemoo.aoifeMotan" }) 必须加，否则，找不到对应的mapper
...
@MapperScan(basePackages = { "org.hemoo.aoifeMotan" })
public class MyBatisConfig {
    ...
    public SqlSessionFactory sqlSessionFactoryBean() throws Exception {
        ...
        sqlSessionFactoryBean.setMapperLocations(resolver.getResources("classpath:org/hemoo/aoifeMotan/dao/mapper/*Mapper.xml"));
